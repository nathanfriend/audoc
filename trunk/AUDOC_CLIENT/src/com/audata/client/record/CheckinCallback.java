 ...
 *
 */
public class CheckinCallback implements ResponseListener {

	private ArrayList records;
	private RecordListPanel parent;
	
	public CheckinCallback(RecordListPanel parent, ArrayList records){
		this.parent = parent;
		this.records = records;
	}
	
	/**
	 * Checks in the records if used selects ok
	 */
